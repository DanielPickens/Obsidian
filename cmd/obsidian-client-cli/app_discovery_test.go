...
func TestDiscoverCommand(t *testing.T) {
	...
	testSvc, ok := services["obsidian_client_cli.testing.TestService"]
...
func TestDiscoverCommand_NoService(t *testing.T) {
	app, err := newApp(&startOpts{
		Target:        app_testing.TestServerAddr(),
		Deadline:      15,
		IsInteractive: false,
...
func TestDiscoverCommand_NoService_NoDiscover(t *testing.T) {
	app, err := newApp(&startOpts{
		Target:        app_testing.TestServerAddr(),
		Deadline:      15,
		IsInteractive: false,
